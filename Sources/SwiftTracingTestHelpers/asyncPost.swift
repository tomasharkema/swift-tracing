...
//   ) async {
//     var handler: () -> Void = {}
//     var notificationHandler: (any NSObjectProtocol)? = switch notification {
//     case let .name(name):
//       center.addObserver(forName: name, object: object, queue: queue) { _ in
//         handler()
...
//       center
//         .addObserver(forName: notificationObject.name, object: object, queue: queue) { _ in
//           handler()
//           notificationHandler = nil
//           handler = {}
//         }
